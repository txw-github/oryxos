# Prompt 记录 — 第一轮
```
https://github.com/oryx-labs
https://github.com/robustmq/mq9
```
本文件记录本项目第一轮 AI 辅助开发过程中，用户输入的所有提示词（按时间顺序）。

---
1.docs理解一下这四个文档，这四个文档就是我要做的事情
2.整理一下这四个文档的格式,整理成md好看的格式,多agent并行处理
3.基于这些信息生成claude.md
4.基于这些信息生成readme,readme参考标准的开源项目来写
5.Architecture 架构图用svg或png画，放在docs/images
5.1注意重叠不要太拥挤
6.用maven初始化这个项目，按照文档中的9个模块，并通过编译打包
7.readme文件的架构图要用画的这个图
8.boot 能java -jar运行了吗？是一个main函数
9.oryxos的cli需要一个main函数，它要能运行，能打印oryxos版本信息
10. 画一个oyrxos的logo放在readme，用svg格式，你自由发挥，logo文件放在images目录下
11. logo放readme中间
12. 这些内容，写入docs/prompt/01.md ，带上序号
13. D:\Desktop\codeai\mq9-main/website 理解一下这个项目代码。 oryxos 要做一个一模一样的主页，你先理解下。看是否需要我做什么
14. 1. github地址：<https://github.com/txw-github/oryxos>  2. 要中英文  3. 域名是oryxos.qqtang.cloud
20. 网页要中英文
